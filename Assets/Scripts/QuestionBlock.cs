...
public class QuestionBlock : MonoBehaviour
{
    ...
    void PresentCoin()
    {
        GameObject spinnigCoin = (GameObject)Instantiate(Resources.Load("Prefabs/Spinning_Coin", typeof(GameObject)));
        spinnigCoin.transform.SetParent(this.transform.parent);
        spinnigCoin.transform.localPosition = new Vector2(originalPosition.x, originalPosition.y + 1);
        StartCoroutine(MoveCoin(spinnigCoin));
    }
